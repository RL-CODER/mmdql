...
class QRegressor(Serializable):
    ...
    def fit(self, state, action, q, **fit_params):
        ...
        """
        #print(" ############### Fitted parameter keys {} from QRegressor.fit q_regressor.py ################".format(fit_params.keys()))
    ...
    def predict(self, *z, **predict_params):
        ...
        state = z[0]
        #print(" ############## predicted parameters keys {} from mushroom q_resgressor.py ############ ".format(predict_params.keys()))
